...
gene_dir='classifiers/ERBB2_PIK3CA_KRAS_AKT1_16'
...
gdsc_rnaseq='/data/vijay/git/pancancer/data/GDSC_EXP_CCLE_converted_name.csv'
gdsc_mut='/data/vijay/git/pancancer/data/GDSC_CCLE_common_mut_cnv_binary.csv'
ccle_maf='/data/vijay/git/pancancer/data/CCLE_DepMap_18Q1_maf_20180207.txt'
gdsc1_phar='/data/vijay/git/pancancer/data/gdsc1_ccle_pharm_fitted_dose_data.txt'
gdsc2_phar='/data/vijay/git/pancancer/data/gdsc2_ccle_pharm_fitted_dose_data.txt'
compound='/data/vijay/git/pancancer/data/compounds.txt'
ex_vlog='/mnt/isilon/data/w_gmi/blanked2lab/vijay/pi3k_GSE69822/WT_PIK3CA_PTENKO_0MIN_vst_counts.csv'
sign='/mnt/isilon/data/w_gmi/blanked2lab/vijay/pi3k_GSE69822/sign_WT_PIK3CA_PTEN_KO.csv'

###############
# Step 1. Pan Cancer target gene classification
############### 

python scripts/pancancer_classifier.py \
        --genes 'ERBB2,KRAS,PIK3CA,AKT1' \
        --diseases 'OV,LUSC,UCS,BRCA,ESCA,CESC,HNSC,LUAD,UCEC,GBM,BLCA,COAD,PAAD,READ,SKCM,STAD' \
        --drop \
        --copy_number \
        --remove_hyper \
        --alt_folder $gene_dir \
        ...
        --alt_genes 'TP53' \
        --alt_diseases 'BLCA,BRCA,CESC,COAD,ESCA,GBM,HNSC,KICH,LGG,LIHC,LUAD,LUSC,PAAD,PRAD,READ,SARC,SKCM,STAD,UCEC'\

###############
# Step 2. Within Disease type gene classification
###############
...
python scripts/map_mutation_class.py \
        --scores $gene_dir \
        --path_genes 'data/pi3k_genes.txt'\
        --copy_number \
        --filename_copy_loss 'data/copy_number_loss_status.tsv' \
        --filename_copy_gain 'data/copy_number_gain_status.tsv' \
...
python scripts/viz/targene_cell_line_predictions_mod.py \
        --classifier $gene_dir \
        --targenes 'ERBB2_MUT,KRAS_MUT,PIK3CA_MUT,AKT1_MUT'  \
...
Rscript --vanilla scripts/viz/targene_ccle_pharmacology_mod.R \
        --classifier $gene_dir \
        --compound $compound
